<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Manage_Events.aspx.cs" Inherits="EventsGSU_FA2018.Events.Manage_Events" %>
            ...
            function writetable(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    tableOutline = tableOutline +
                        '<a class = "eventblock" href="' + 'http://localhost/EventsGSU_FA2018/Events/user_manage_event.aspx?eventID=' +
