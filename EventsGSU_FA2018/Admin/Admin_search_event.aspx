<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin_search_event.aspx.cs" Inherits="EventsGSU_FA2018.Admin.Admin_search_event" %>
                ...
                function writetable(data) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                        tableOutline = tableOutline +
                            '<a class = "eventblock" href="' + 'http://localhost/EventsGSU_FA2018/admin/Admin_Event_manage_Page.aspx?eventID=' +
